...
public class ReadHistory 
{
	...
	public void readHistory() throws SQLException, ClassNotFoundException, IOException
	{
		...
		String user = "root";
		String password = "lifeicscs880603";
		Class.forName(driver);
		Connection conn = DriverManager.getConnection(db_url, user, password);
		Statement statement = conn.createStatement(); 

		String file = "C:/Users/lifei/Dropbox/currentTasks/4. NaliRSystem/workspace/NaliRWeb/src/zfiles/history.txt"; 
		...
		while(scan.hasNextLine())
		{
			...
			String insert = "INSERT mas.history VALUES (" + count + ", " + "'" + query + "')"; 
			count++; 
