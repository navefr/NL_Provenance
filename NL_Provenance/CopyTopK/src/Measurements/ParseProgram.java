...
*/
	...
	public static Atom BuildAtom (String text)
	{
		...
		for (int i = 0; i < params.length; i++) 
		{
			vars[i] = ParseParam(params[i].trim().replaceAll("'", ""), cats[i]); 
		}
	...
	private static String [] SelectCategories (String atomName)
	{
		...
		case "exports":
			...
			break;
		case "basicpart":
			retVal = new String [] {"Part", "Price"};
			break;
		case "assembly":
			retVal = new String [] {"Part", "Part", "Price"};
			break;
		case "subpartcost":
			retVal = new String [] {"Part", "Part", "Price"};
			break;
		case "bom":
			...
			break;
		case "Mul":
			retVal = new String [] {"numder", "numder", "numder"};
			break;
		case "LEQ":
			retVal = new String [] {"numder", "numder"};
			break;
		default:
